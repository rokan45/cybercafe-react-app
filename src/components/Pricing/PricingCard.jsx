...
const PricingCard = ({ pricing }) => {
    console.log(pricing)
    const { name, price, currency, tagline, features, cta, highlighted,badge } = pricing
    return (
        <div className={`relative border p-6 rounded-xl flex flex-col gap-4 transition-all duration-300
            ...
            <h1 className='text-xl font-bold text-center'>{name}{badge && <div className="badge badge-accent ml-2">Popular</div>}</h1>
